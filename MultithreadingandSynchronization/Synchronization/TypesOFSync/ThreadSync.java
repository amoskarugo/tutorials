...
public class ThreadSync {
    ...
    /*
    * Explanation: The synchronized bookTicket()
    * method ensures that only one thread books tickets at a time,
    *  preventing overbooking and ensuring correct availability.
    * */
}
