...
public class ProcessSync {
    ...
    /*
    * Explanation: Two threads perform deposit and withdrawal operations simultaneously.
    * The synchronized methods prevent race conditions, ensuring consistent balance updates.
    * */
}
